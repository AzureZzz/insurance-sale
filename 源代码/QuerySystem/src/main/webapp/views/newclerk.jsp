      ...
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <ol class="breadcrumb navbar-breadcrumb">
            <li class="active">销售员管理系统</li>
            <li class="active">新增销售员</li>
          </ol>
      ...
      <div class="row-fluid">
        <div class="span12">
          <fieldset class="layui-elem-field layui-field-title" data-dismiss="modal" aria-label="Close" style="margin-top: 10px;">
            <legend><i class="fa fa-pencil"></i><font color="#5f9ea0">销售员注册</font></legend>
          </fieldset>
          <form class="layui-form layui-form-pane" action="">
            <div class="layui-form-item">
              <label class="layui-form-label">密码</label>
              <div class="layui-input-inline">
                <input id="c_ps" type="password" name="password" lay-verify="pass" placeholder="请输入密码" autocomplete="off" class="layui-input">
              </div>
            </div>
            <div class="layui-form-item">
              <label class="layui-form-label" for="c_reps">重复密码</label>
              <div class="layui-input-inline">
                <input id="c_reps" type="password" name="c_reps" lay-verify="pass" placeholder="请输入重复密码" autocomplete="off" class="layui-input">
              </div>
            </div>
            <div class="layui-form-item">
              <div class="layui-input-block">
                <button id="c_new" class="layui-btn" lay-submit="" lay-filter="*">提交</button>
      ...
      <div class="modal-body">
        ...
        <form class="layui-form layui-form-pane" action="">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="radio" name="b_sex" value="男" title="男">
...
<script>
  $(function () {
     $("#c_new").click(function () {
         var password = $("#c_ps").val();
         var repassword = $("#c_reps").val();
         if(password == repassword&&password!=""){
             ...
             $.ajax({
                 ...
                 success: function(data) {
                     layer.msg('注册成功！ClerkId:'+data.msg, {icon: 1});
                 }
             });
         }else{
