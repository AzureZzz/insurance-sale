  ...
  <div class="row content-container">
    ...
    <div class="row-fluid">
      <fieldset class="layui-elem-field layui-field-title" data-dismiss="modal" aria-label="Close" style="margin-top: 10px;">
        <legend><i class="fa fa-pencil"></i><font color="#5f9ea0">录入保单信息</font></legend>
      </fieldset>
      <div class="col-lg-offset-1 col-lg-6 col-md-6 col-xs-12">
        <form class="layui-form layui-form-pane" action="">
            ...
            <div class="layui-inline">
              ...
              <div class="layui-input-block">
                <select id="polName" name="polName" lay-filter="aihao">
                  ...
                  <option value="补充医疗险">补充医疗险</option>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
              <input id="money" type="text" name="money" lay-verify="required|number|money" placeholder="请输入金额" autocomplete="off" class="layui-input">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            <div class="layui-input-block">
              <button id="b_post" class="layui-btn" lay-submit="" lay-filter="*">提交</button>
    ...
    $(function () {
        $("#b_post").click(function(){
            layer.confirm('确认提交？', {
                ...
                var url = "http://localhost:8081/bill";
                $.ajax({
                    url: url,
                    type: 'POST',
                    headers:{"Clerk-Id":<%=request.getSession().getAttribute("cId")%>},
                    data: JSON.stringify(data),
                    contentType: 'application/json',
                    success: function() {
                        layer.msg('出单成功！', {icon: 1});
                    },
                    error:function () {
                        layer.msg('出单失败！', {icon: 1});
                    }
                });
            }, function(){
            });
