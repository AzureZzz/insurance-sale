    ...
    <div class="row-fluid">
      <div class="span12">
        <div class="page-header">
          <h3 class="text-info">业务员列表<a href="download/1"><small> <small>下载Excel</small></small></a></h3>
        </div>
        <table id="clerks_table" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
          <thead>
          <tr>
            <th>业务员ID</th>
            <th>性别</th>
      ...
      <div class="modal-body">
        ...
        <form class="layui-form layui-form-pane" action="">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
              <input id="c_name" type="text" name="c_name" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
          </div>
          <div class="layui-form-item">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-inline">
              ...
              <div class="layui-input-block">
                <input id="c_mobile" type="tel" name="c_mobile" lay-verify="required|phone" autocomplete="off" class="layui-input">
              </div>
            </div>
          </div>
          ...
          <div class="layui-form-item">
            <div class="layui-input-block">
              <button id="c_put" class="layui-btn" lay-submit="" lay-filter="*" >提交</button>
...
<script src="../views/js/clerks.js"></script>
</body>
</html>
