...
<div class="modal show" style="margin-top: 100px" id="passwordModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                ...
                <form class="layui-form layui-form-pane">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input id="clerkId" type="text" name="clerkId" value="123456" lay-verify="require" placeholder="请输入销售员Id" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
